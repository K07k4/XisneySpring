...
public class RestauranteController {
    ...
    public @ResponseBody
    ResponseEntity<String> addRestaurante(@RequestParam Integer idParque, @RequestParam String nombre,
    ...
    @GetMapping(path = "/get")
    public @ResponseBody
    Optional<Restaurante> getRestaurante(@RequestParam int id) {
    ...
    @GetMapping(path = "/all")
    public @ResponseBody
    Iterable<Restaurante> getAllRestaurantes() {
    ...
    public @ResponseBody
    ResponseEntity<String> deleteRestaurante(@RequestParam Integer id) {
