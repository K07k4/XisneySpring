...
public class ReservaEspectaculoController {
	...
	public ReservaEspectaculoController(UsuarioRepository usuarioRepository,
			EspectaculoRepository espectaculoRepository, ReservaEspectaculoRepository reservaEspectaculoRepository) {
	...
	public @ResponseBody ResponseEntity<String> addReservaEspectaculo(@RequestParam Integer idUsuario,
			@RequestParam Integer idEvento, @RequestParam String fechaReserva, @RequestParam Integer personas) {
		...
		try {
			...
			return ResponseEntity.badRequest()
					.body("Error al parsear la fecha de fin del evento con ID " + idEvento.toString());
		}
